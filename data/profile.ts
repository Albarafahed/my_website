export const profile = {
  ...
  // avatar: "https://github.com/Albarafahed.png?size=512",
avatar: "/images/albara.png",
  cvPath: "/albara-fahed-alharissy-cv.pdf",
...
export const siteConfig = {
 url: "https://albaradev.netlify.app",
  ...
  description:
    "Portfolio of Albara Fahed Alharissy, a Junior C#/.NET Backend Developer building reliable applications with ASP.NET Core, Entity Framework Core, and SQL Server.",
} as const;
